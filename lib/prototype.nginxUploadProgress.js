/*
 * Nginx Upload Progress for Prototype
 *
 * Example:
 *
 * <style type="text/css">
    ...
    uploadProgress: function(form, options) {
        form.observe('submit', function() {    
            ...
            new PeriodicalExecuter(function(timer) {
                nginxUploadProgress(timer, options['nginx_progress_url'], options['progress_bar_id'], uuid)
            }, options['interval']);
        });
    }
});

var nginxUploadProgress = function(timer, nginx_progress_url, progress_bar_id, uuid) {
    new Ajax.Request(
        nginx_progress_url, {
            method: 'get',
